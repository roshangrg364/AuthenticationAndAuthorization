...
{
    public partial class addedpropertyttoactivitylog : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    table_name = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    action_on = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2022, 3, 18, 13, 56, 33, 222, DateTimeKind.Local).AddTicks(7020)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    category_id = table.Column<long>(type: "bigint", maxLength: 11, nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
