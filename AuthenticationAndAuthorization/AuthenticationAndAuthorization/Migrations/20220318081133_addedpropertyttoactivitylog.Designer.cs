...
namespace AuthenticationAndAuthorization.Migrations
{
    ...
    [Migration("20220318081133_addedpropertyttoactivitylog")]
    partial class addedpropertyttoactivitylog
    {
            ...
            modelBuilder.Entity("BaseModule.AuditManagement.Audit", b =>
                {
                    ...
                    b.Property<DateTime>("ActionOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 3, 18, 13, 56, 33, 222, DateTimeKind.Local).AddTicks(7020))
                        .HasColumnName("action_on");
